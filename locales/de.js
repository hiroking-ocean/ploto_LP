export default {
  ...
  i18n: {
    ...
    manual_basic_file_menu_desc: "Das 'Datei'-Menü ermöglicht folgende Aktionen:<br>• **Neu**: Eine neue Projektdatei erstellen.<br>• **Öffnen**: Eine Projektdatei (.ploto) von Ihrem PC auswählen und laden.<br>• **Speichern**: Das aktuelle Projekt überschreiben und speichern.<br>• **Speichern unter**: Das Projekt unter einem neuen Dateinamen speichern.<br>• **Excel-Export / Drucken [PRO]**: Gantt-Diagramme oder Aufgabenlisten als Excel oder PDF exportieren (Pro-Funktionen).",
    manual_basic_help_menu_title: "Hilfemenü",
    manual_basic_help_menu_desc: "Das 'Hilfe'-Menü ermöglicht folgende Aktionen:<br>• **Handbuch**: Diese Handbuchseite öffnen.<br>• **Änderungsprotokoll**: Den Update-Verlauf der App anzeigen.<br>• **Lizenz**: Lizenzinformationen anzeigen.<br>• **Language**: Die App-Sprache ändern (Japanisch, Englisch, Deutsch, Französisch, Koreanisch).",
