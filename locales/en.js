export default {
  ...
  i18n: {
    ...
    features_title: "How a task looks depends on the view",
    features_subtitle: "From here, follow a single task through five views and see how differently the same work can look, screen by screen.",
    ...
    feature_matrix_title: "Use two axes to decide what to tackle first",
    feature_matrix_lead: "When priority is only High, Medium, or Low, every task tends to end up High. How urgent is it, and how important is it really? Separating those questions reveals the differences between tasks.",
    feature_matrix_p1_title: "Plot urgency × importance",
    feature_matrix_p1_desc: "Consider urgency and importance for each task, then plot it on the plane. Instead of treating “urgent” as “important,” preserve the two judgments as a single position.",
    feature_matrix_p2_title: "Compare tasks by position",
    feature_matrix_p2_desc: "A priority score is calculated automatically from where each task is placed. Instead of making everything top priority, compare what to tackle first through the differences in position.",
    feature_matrix_p3_title: "Do not lose sight of important, non-urgent work",
    feature_matrix_p3_desc: "Work that sinks when sorted by deadline remains visible in the “important but not urgent” area. Even when immediate demands take over, you do not lose track of what keeps getting postponed.",
    feature_whiteboard_title: "Finally, see everything on one canvas",
    feature_whiteboard_lead: "The tasks that now carry dates, status, context, and priority are finally spread across a single canvas. Instead of snapping everything to a grid, move tasks, draw relationships, and add the summaries you need. It is a whiteboard for grasping the whole through position and connection.",
    feature_whiteboard_p1_title: "Draw the whole picture freely",
    feature_whiteboard_p1_desc: "Place not only tasks but also shapes, text, and sticky notes wherever you want. Add frames and lines to show relationships, and express on one canvas the clusters and flows that a table cannot reveal.",
    feature_whiteboard_p2_title: "Put live tasks on the canvas",
    feature_whiteboard_p2_desc: "Place the same tasks you have been working with in the other views on the canvas too. Changes to progress, deadlines, and assignees are reflected automatically, so there is nothing to re-pin or rewrite.",
    feature_whiteboard_p3_title: "Connect the tasks you want to aggregate",
    feature_whiteboard_p3_desc: "Connect tasks with arrows to a small summary panel (widget) that displays progress and other totals. Only the connected tasks are aggregated, letting you check the numbers for exactly the group of work you want and use them to decide what comes next.",
    ...
    plan_compare_desc: "Building and editing Gantt charts, plus importing from and exporting to Excel, stay free with no time limit. Views beyond Gantt — Kanban, Priority Matrix, Notes, and more — need Pro only when you create a new one.",
    plan_compare_col_feature: "Feature",
    plan_compare_col_free: "Free",
    plan_compare_col_pro: "Pro",
    plan_compare_kanban: "Kanban boards",
    plan_compare_kanban_free: "New boards need Pro (existing ones stay editable)",
    plan_compare_kanban_pro: "Unlimited",
    plan_compare_whiteboard: "Whiteboards",
    plan_compare_whiteboard_free: "New boards need Pro (existing ones stay editable)",
    ...
    plan_compare_template: "Project templates",
    plan_compare_template_free: "Importing is free",
    plan_compare_template_pro: "Exporting (.ploto-pack) too",
    ...
    security_c3_desc: "Install Ploto from Microsoft Store and receive updates through the Store as well. There is no need to find and reinstall a new installer for every release.",
