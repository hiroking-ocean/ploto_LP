export default {
  ...
  i18n: {
    ...
    features_title: "The small things that trip up day-to-day scheduling, handled for you",
    features_subtitle: "Details that quietly matter, designed so you never have to set them up yourself.",
    ...
    feat_views_title: "Enter it once, view it any way you like",
    ...
    views_subtitle: "Ploto simply shows the same task in whichever view fits what you are deciding. Edit it anywhere and it is still one record, so nothing has to be copied across or reconciled.",
    views_source_label: "You enter it once",
    views_source_task: "Homepage build",
    views_source_progress: "40% done",
    views_source_caption: "That one task is what every view below is showing.",
    views_gantt_title: "Gantt chart (schedule)",
    views_gantt_desc: "Decide when work starts and how long it takes.",
    views_kanban_title: "Kanban",
    views_kanban_desc: "Move a card to change which stage the task is in.",
    views_matrix_title: "Priority matrix",
    views_matrix_desc: "Sort by urgency and importance to decide what comes first.",
    views_members_title: "Member tasks",
    views_members_desc: "See how much each person is carrying and rebalance.",
    views_note_title: "Notes",
    views_note_desc: "Keep decisions and findings written down per task.",
    views_whiteboard_title: "Whiteboard",
    views_whiteboard_desc: "Lay tasks out as a diagram to share the bigger picture.",
    views_note: "Move a card into the \"Development\" column on the board, for example, and that task's stage changes — the schedule grid and the to-do list in Notes show the same state. However many views you add, there is still only one set of data.",
