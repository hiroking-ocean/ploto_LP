export default {
  ...
  i18n: {
    ...
    feature_note_p1_desc: "The task hierarchy is the heading structure. You never start from a blank document.",
    feature_note_p2_title: "Search across every note",
    feature_note_p2_desc: "Even if you cannot remember which task you wrote it on, a word from the text gets you there.",
    feature_note_p3_title: "To-dos live here too",
    feature_note_p3_desc: "Create checklist items as you write. They collect in the same place as the kanban stage checklists.",
