export default {
  ...
  i18n: {
    ...
    pricing_title: "Start on your own. Go Pro only when you need to.",
    pricing_desc: "Core tools for getting work done, including Gantt charts and notes, remain free to use. Unlock additional features with a one-time Pro purchase only when you need them.",
