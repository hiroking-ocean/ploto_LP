export default {
  ...
  i18n: {
    ...
    manual_basic_file_menu_desc: "『ファイル』メニューから以下の操作が行えます。<br>・**新規**: 新しいプロジェクトファイルを作成します。<br>・**開く**: PC内のプロジェクトファイル（.ploto）を選択して読み込みます。<br>・**保存**: 現在のプロジェクトを上書き保存します。<br>・**別名で保存**: 新規ファイル名で保存します。<br>・**Excel出力/印刷 [PRO]**: ガントチャートやタスク一覧をExcelやPDFとしてエクスポートします（Pro機能）。",
    manual_basic_help_menu_title: "ヘルプメニュー",
    manual_basic_help_menu_desc: "『ヘルプ』メニューから以下の操作が行えます。<br>・**マニュアル**: 本マニュアルページを開きます。<br>・**更新履歴**: アプリの更新履歴を確認できます。<br>・**ライセンス**: ライセンス情報を確認します。<br>・**Language**: アプリの表示言語（日本語、英語、ドイツ語、フランス語、韓国語）を切り替えます。",
    ...
    manual_basic_header_save_desc: "フロッピーディスクのアイコンをクリックすることで、現在の変更内容を手동で即座に保存します（基本的には自動保存されますが、手動での保存も可能です）。",
