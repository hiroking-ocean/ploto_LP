export default {
  ...
  i18n: {
    ...
    beta_title: "基本機能は将来も永久無料！<br>（一部便利機能は買い切り課金）",
    beta_desc: "Plotoは現在ベータテスト中です。ガントチャートやカンバンビュー、優先度マトリクスなどの基本機能は、将来も永久に無料で提供することを目指しています。課金要素としては、Excelファイルエクスポートや、祝日一括導入などの便利機能に対する買い切り課金を想定しています。",
    beta_price: "ベータ版価格",
