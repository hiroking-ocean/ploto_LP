export default {
  ...
  i18n: {
    ...
    feature_kanban_title: "카드를 옮겨 공정을 바꿉니다",
    feature_kanban_lead: "같은 작업을 '지금 어느 공정에 있는지'의 나열로 보는 화면입니다. 카드를 오른쪽 열로 옮기면 그 작업의 공정이 바뀝니다. 공정표 쪽 표시도 같은 순간에 바뀌므로, 어느 한쪽을 고치는 것을 잊을 일이 없습니다.",
    feature_kanban_p1_title: "옮기는 것만으로 상태가 바뀝니다",
    ...
    feature_note_p1_desc: "작업의 계층이 그대로 제목이 됩니다. 빈 문서에서 구성을 고민할 필요가 없습니다.",
    feature_note_p2_title: "본문을 가로질러 검색할 수 있습니다",
    feature_note_p2_desc: "어느 작업에 썼는지 기억나지 않아도 본문의 단어로 찾아갈 수 있습니다.",
    feature_note_p3_title: "ToDo도 여기에 둘 수 있습니다",
    feature_note_p3_desc: "쓰면서 체크 항목을 만들 수 있습니다. 칸반의 표준 ToDo와 같은 곳에 모입니다.",
