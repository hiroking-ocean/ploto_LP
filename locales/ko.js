export default {
  ...
  i18n: {
    ...
    features_title: "하나의 작업은 하나의 시각만으로는 파악할 수 없다",
    features_subtitle: "지금부터 작업 하나를 따라가 봅니다. 5개의 화면을 지나는 동안 같은 작업이 얼마나 다르게 보이는지 확인해 보세요.",
    ...
    feature_matrix_title: "어느 것부터 손댈지 정합니다",
    feature_matrix_lead: "긴급도와 중요도의 두 축에 작업을 놓는 화면입니다. 마감이 가까운 순으로 처리하다 보면 뒤로 밀리기 쉬운 '중요하지만 급하지 않은 일'이 놓인 위치로 드러납니다. 여기서 정한 우선순위도 같은 한 건에 기록됩니다.",
    feature_matrix_p1_title: "두 축에 놓기만 하면 우선순위가 정해집니다",
    feature_matrix_p1_desc: "작업을 끌어다 놓은 위치에서 우선순위 점수가 자동으로 계산됩니다.",
    feature_matrix_p2_title: "중요하지만 급하지 않은 일이 보입니다",
    feature_matrix_p2_desc: "마감만으로 늘어놓으면 가라앉는 일이 사분면의 위치로 계속 남습니다.",
    feature_matrix_p3_title: "표시 모드를 바꿀 수 있습니다",
    feature_matrix_p3_desc: "점만 보이는 표시와 카드를 펼친 표시를 오가며 조망과 확인을 나눠 쓸 수 있습니다.",
    feature_whiteboard_title: "마지막으로 전체를 한 장으로 봅니다",
    feature_whiteboard_lead: "여기까지 일정·공정·기록·우선순위를 갖게 된 한 건이 다른 작업들과 나란히 한 장의 판에 올라갑니다. 접착 메모와 다른 점은, 올려 둔 카드가 진행률과 기한을 늘 최신 상태로 계속 보여준다는 것입니다. 공정표에서 진행률을 고치면 이 판의 표시도 따라옵니다.",
    feature_whiteboard_p1_title: "카드는 정적인 접착 메모가 아닙니다",
    feature_whiteboard_p1_desc: "올려 둔 뒤에도 진행률·기한·담당을 최신 상태로 계속 표시합니다. 다시 붙이는 작업이 생기지 않습니다.",
    feature_whiteboard_p2_title: "선으로 이어 관계를 그릴 수 있습니다",
    feature_whiteboard_p2_desc: "도형과 커넥터를 더해 작업 간 의존과 흐름을 판 위에 그대로 그릴 수 있습니다.",
    feature_whiteboard_p3_title: "집계 위젯을 놓을 수 있습니다",
    feature_whiteboard_p3_desc: "진행률 집계를 판에 올려 그대로 대시보드로 쓸 수 있습니다.",
