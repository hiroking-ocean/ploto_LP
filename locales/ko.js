export default {
  ...
  i18n: {
    ...
    features_title: "매일의 일정 관리에서 걸리는 부분을 미리 없앱니다",
    features_subtitle: "작지만 효과가 큰 기능들을, 따로 손대지 않아도 쓸 수 있게 설계했습니다.",
    ...
    feat_auto_title: "하나만 옮기면 뒤 일정도 따라옵니다",
    ...
    feat_views_title: "입력은 한 번, 보는 방식은 여러 가지",
    ...
    views_subtitle: "Ploto는 같은 작업을 목적에 맞는 화면으로 바꿔 보여줄 뿐입니다. 어느 화면에서 고쳐도 내용은 같은 한 건이므로, 옮겨 적거나 대조할 필요가 없습니다.",
    views_source_label: "등록은 한 건뿐",
    views_source_task: "메인 페이지 구현",
    views_source_progress: "진행률 40%",
    views_source_caption: "이 한 건이 아래 모든 화면에 그대로 나타납니다.",
    views_gantt_title: "간트 차트(공정표)",
    views_gantt_desc: "언제 시작해서 얼마나 걸리는지 정합니다.",
    views_kanban_title: "칸반",
    views_kanban_desc: "카드를 옮겨 지금 어느 공정에 있는지 바꿉니다.",
    views_matrix_title: "우선순위 매트릭스",
    views_matrix_desc: "긴급도와 중요도로 배치해 무엇부터 할지 정합니다.",
    views_members_title: "담당자별 작업",
    views_members_desc: "누구에게 얼마나 몰려 있는지 보고 배분을 조정합니다.",
    views_note_title: "노트",
    views_note_desc: "정해진 사항과 알게 된 점을 작업별로 남깁니다.",
    views_whiteboard_title: "화이트보드",
    views_whiteboard_desc: "작업을 도형으로 배치해 전체 관계를 그려 공유합니다.",
    views_note: "예를 들어 칸반에서 카드를 '구현' 열로 옮기면 그 작업의 공정이 바뀌고, 공정표 목록에도 노트의 ToDo에도 같은 상태가 나타납니다. 뷰를 아무리 늘려도 관리하는 데이터는 하나뿐입니다.",
