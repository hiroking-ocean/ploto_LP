export default {
  ...
  i18n: {
    ...
    beta_title: "기본 기능은 앞으로도 영구히 무료!<br>(일부 편의 기능은 유료 구매)",
    beta_desc: "Ploto는 현재 베타 테스트 중입니다. 간트 차트, 칸반 보드, 우선순위 매트릭스 등의 기본 기능은 향후에도 영구 무료로 제공하는 것을 목표로 하고 있습니다. 과금 요소로는 엑셀 파일 내보내기 및 편의 기능(공휴일 일괄 가져오기 등)에 대한 일회성 구매를 상정하고 있습니다.",
    beta_price: "베타 가격",
