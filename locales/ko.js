export default {
  ...
  i18n: {
    ...
    plan_compare_desc: "간트 차트 작성·편집과 Excel 가져오기·내보내기는 기간 제한 없이 무료입니다. 간트 외의 화면(칸반·우선순위 매트릭스·노트 등)은 새로 만들 때만 Pro가 필요합니다.",
    plan_compare_col_feature: "기능",
    plan_compare_col_free: "무료",
    plan_compare_col_pro: "Pro",
    plan_compare_kanban: "칸반 보드",
    plan_compare_kanban_free: "새로 만들 때만 Pro（기존 보드는 계속 편집 가능）",
    plan_compare_kanban_pro: "제한 없음",
    plan_compare_whiteboard: "화이트보드",
    plan_compare_whiteboard_free: "새로 만들 때만 Pro（기존 보드는 계속 편집 가능）",
    ...
    plan_compare_template: "프로젝트 템플릿",
    plan_compare_template_free: "가져오기만 무료",
    plan_compare_template_pro: "내보내기(.ploto-pack)도 가능",
    plan_compare_holidays: "공휴일 등록",
    plan_compare_holidays_free: "수동 추가 및 편집",
    plan_compare_holidays_pro: "수동 + 국가별 공휴일 일괄 가져오기",
    plan_compare_note: "※ 우선순위 매트릭스·멤버별 작업·노트를 새로 만들 때도 칸반과 마찬가지로 Pro가 필요합니다(이미 만든 항목은 계속 편집·열람 가능). 표에 없는 기능은 Pro 없이도 제한 없이 사용할 수 있습니다. 단, 다른 사람이 만든 화이트보드는 Pro 없이 보기 전용입니다.",
    plan_compare_license_note: "※ Pro가 필요한 것은 새로 만들 때뿐입니다. Pro로 만든 화면이 들어 있는 파일도 Pro 없이 그대로 열고 편집할 수 있습니다. 시리얼 코드는 본인이 쓰는 여러 기기에 등록할 수 있으며, 등록 후에는 오프라인에서도 인증됩니다.",
    ...
    security_c3_desc: "Ploto는 Microsoft Store에서 설치하고 업데이트도 Store를 통해 받을 수 있습니다. 새 버전이 나올 때마다 설치 파일을 찾아 다시 설치할 필요가 없습니다.",
